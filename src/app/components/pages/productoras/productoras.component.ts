...
export class ProductorasComponent implements OnInit {
  ...
  constructor(private miService:ProductorasService,  private router: Router) { }
  ...
  nuevoModelo(){
    this.router.navigate(['/nuevaProductora']);
  }
  ...
  selectModel(miModelo: Productora){
